...
import { GATEWAY_NAME } from "../../brand"
  ...
  return (
    <Show when={state.snap()}>
      <ConfigPage
        ...
        description="The models Northstar uses when an agent or command doesn't pin its own."
      >
        ...
        <Card class="ui-card" padding={0}>
          <header class="ui-card-header">
            <div>
              ...
              <p>Control which {GATEWAY_NAME} models appear in model lists.</p>
            </div>
          ...
          <div class="ui-form">
            ...
            >
              <span>
                ...
                <small>Hide Northstar Gateway models whose providers may use your prompts for training.</small>
            ...
            <Show when={state.gateway()}>
              <div class="models-privacy-filter-group">
                ...
                <button
                  ...
                  type="button"
                  aria-label="Hide Northstar Gateway models whose providers may use prompts for training"
