export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.basic": "الإكمال التلقائي في Northstar",
  "kilocode:autocomplete.statusBar.tooltip.disabled": "الإكمال التلقائي في Northstar (معطل)",
  ...
  "kilocode:autocomplete.toggleMessage": "الإكمال التلقائي في Northstar {{status}}",
  ...
  "kilocode:autocomplete.input.title": "Northstar: مهمة سريعة",
  "kilocode:autocomplete.input.placeholder": "مثال: 'أعد هيكلة هذه الدالة لتكون أكثر كفاءة'",
  "kilocode:autocomplete.commands.generateSuggestions": "Northstar: إنشاء تعديلات مقترحة",
  ...
  "kilocode:autocomplete.codeAction.title": "Northstar: تعديلات مقترحة",
  "kilocode:autocomplete.chatParticipant.fullName": "وكيل Northstar",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "يتم حظر الإكمال التلقائي في Northstar بسبب تعارض مع GitHub Copilot. لإصلاح ذلك، يجب تعطيل اقتراحات Copilot المضمنة.",
  ...
  "kilocode:autocomplete.creditsExhausted.message":
    "تم إيقاف الإكمال التلقائي في Northstar مؤقتا. الأسباب المحتملة: لا توجد أرصدة متبقية في حساب Northstar الخاص بك، أو أن مفتاح API المكون (BYOK) وصل إلى حد الحصة. أضف أرصدة Northstar أو تحقق من إعدادات مفتاح API لاستئناف الإكمال التلقائي.",
  "kilocode:autocomplete.creditsExhausted.addCredits": "إضافة أرصدة",
  "kilocode:autocomplete.authError.message":
    "تم إيقاف الإكمال التلقائي في Northstar مؤقتا بسبب مشكلة مصادقة. الأسباب المحتملة: لم تسجل الدخول إلى Northstar، أو أن مفتاح API (BYOK) غير صالح أو مفقود. يرجى تسجيل الدخول مرة أخرى أو التحقق من إعدادات مفتاح API للمزود.",
}
