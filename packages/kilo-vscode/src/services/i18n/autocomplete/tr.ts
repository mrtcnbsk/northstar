export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.basic": "Northstar otomatik tamamlama",
  "kilocode:autocomplete.statusBar.tooltip.disabled": "Northstar otomatik tamamlama (devre dışı)",
  ...
  "kilocode:autocomplete.toggleMessage": "Northstar otomatik tamamlama {{status}}",
  ...
  "kilocode:autocomplete.input.title": "Northstar: Hızlı görev",
  "kilocode:autocomplete.input.placeholder": "örn. 'bu fonksiyonu daha verimli olacak şekilde yeniden düzenle'",
  "kilocode:autocomplete.commands.generateSuggestions": "Northstar: Önerilen düzenlemeler oluştur",
  ...
  "kilocode:autocomplete.codeAction.title": "Northstar: Önerilen düzenlemeler",
  "kilocode:autocomplete.chatParticipant.fullName": "Northstar aracı",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "Northstar otomatik tamamlama, GitHub Copilot ile çakışma nedeniyle engelleniyor. Bunu düzeltmek için Copilot'un satır içi önerilerini devre dışı bırakmalısınız.",
  ...
  "kilocode:autocomplete.creditsExhausted.message":
    "Northstar otomatik tamamlama duraklatıldı. Olası nedenler: Northstar hesabınızda kalan kredi yok veya yapılandırılmış API anahtarınız (BYOK) kota sınırına ulaştı. Otomatik tamamlamayı sürdürmek için Northstar kredisi ekleyin veya API anahtarı yapılandırmanızı kontrol edin.",
  "kilocode:autocomplete.creditsExhausted.addCredits": "Kredi ekle",
  "kilocode:autocomplete.authError.message":
    "Northstar otomatik tamamlama bir kimlik doğrulama sorunu nedeniyle duraklatıldı. Olası nedenler: Northstar'da oturum açmadınız veya API anahtarınız (BYOK) geçersiz ya da eksik. Lütfen tekrar oturum açın veya sağlayıcı API anahtarı ayarlarınızı kontrol edin.",
}
