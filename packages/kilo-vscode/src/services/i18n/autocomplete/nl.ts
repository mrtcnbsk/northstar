export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.basic": "Northstar automatisch aanvullen",
  "kilocode:autocomplete.statusBar.tooltip.disabled": "Northstar automatisch aanvullen (uitgeschakeld)",
  ...
  "kilocode:autocomplete.toggleMessage": "Northstar automatisch aanvullen {{status}}",
  ...
  "kilocode:autocomplete.input.title": "Northstar: Snelle taak",
  "kilocode:autocomplete.input.placeholder": "bijv. 'refactor deze functie zodat deze efficiënter is'",
  "kilocode:autocomplete.commands.generateSuggestions": "Northstar: Voorgestelde bewerkingen genereren",
  ...
  "kilocode:autocomplete.codeAction.title": "Northstar: Voorgestelde bewerkingen",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "Northstar automatisch aanvullen wordt geblokkeerd door een conflict met GitHub Copilot. Schakel de inline suggesties van Copilot uit om dit op te lossen.",
  ...
  "kilocode:autocomplete.creditsExhausted.message":
    "Northstar Autocomplete is gepauzeerd. Mogelijke oorzaken: je Northstar-account heeft geen credits meer, of je geconfigureerde API-sleutel (BYOK) heeft de quotumlimiet bereikt. Voeg Northstar-credits toe of controleer je API-sleutelconfiguratie om autocomplete te hervatten.",
  "kilocode:autocomplete.creditsExhausted.addCredits": "Credits toevoegen",
  "kilocode:autocomplete.authError.message":
    "Northstar Autocomplete is gepauzeerd vanwege een authenticatieprobleem. Mogelijke oorzaken: je bent niet aangemeld bij Northstar, of je API-sleutel (BYOK) is ongeldig of ontbreekt. Meld je opnieuw aan of controleer de API-sleutelinstellingen van je provider.",
}
