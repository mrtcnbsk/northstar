export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.basic": "Northstar オートコンプリート",
  "kilocode:autocomplete.statusBar.tooltip.disabled": "Northstar オートコンプリート (無効)",
  ...
  "kilocode:autocomplete.toggleMessage": "Northstar オートコンプリート {{status}}",
  ...
  "kilocode:autocomplete.input.title": "Northstar: クイックタスク",
  "kilocode:autocomplete.input.placeholder": "例: 'この関数をより効率的にリファクタリングする'",
  "kilocode:autocomplete.commands.generateSuggestions": "Northstar: 提案された編集を生成",
  ...
  "kilocode:autocomplete.codeAction.title": "Northstar: 提案された編集",
  "kilocode:autocomplete.chatParticipant.fullName": "Northstar エージェント",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "Northstar オートコンプリートは GitHub Copilot との競合によりブロックされています。修正するには、Copilot のインライン提案を無効にする必要があります。",
  ...
  "kilocode:autocomplete.creditsExhausted.message":
    "Northstar オートコンプリートは一時停止されました。考えられる原因: Northstar アカウントに残りクレジットがない、または設定済みの API キー (BYOK) がクォータ上限に達しています。オートコンプリートを再開するには、Northstar クレジットを追加するか API キー設定を確認してください。",
  "kilocode:autocomplete.creditsExhausted.addCredits": "クレジットを追加",
  "kilocode:autocomplete.authError.message":
    "Northstar オートコンプリートは認証の問題により一時停止されました。考えられる原因: Northstar にサインインしていない、または API キー (BYOK) が無効または不足しています。再度サインインするか、プロバイダーの API キー設定を確認してください。",
}
