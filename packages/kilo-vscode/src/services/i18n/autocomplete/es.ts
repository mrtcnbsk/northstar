export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.basic": "Autocompletado de Northstar",
  "kilocode:autocomplete.statusBar.tooltip.disabled": "Autocompletado de Northstar (deshabilitado)",
  ...
  "kilocode:autocomplete.toggleMessage": "Autocompletado de Northstar {{status}}",
  ...
  "kilocode:autocomplete.input.title": "Northstar: Tarea rápida",
  "kilocode:autocomplete.input.placeholder": "p. ej., 'refactoriza esta función para que sea más eficiente'",
  "kilocode:autocomplete.commands.generateSuggestions": "Northstar: Generar ediciones sugeridas",
  ...
  "kilocode:autocomplete.codeAction.title": "Northstar: Ediciones sugeridas",
  "kilocode:autocomplete.chatParticipant.fullName": "Agente de Northstar",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "El autocompletado de Northstar está bloqueado por un conflicto con GitHub Copilot. Para solucionarlo, debes deshabilitar las sugerencias en línea de Copilot.",
  ...
  "kilocode:autocomplete.creditsExhausted.message":
    "El autocompletado de Northstar se ha pausado. Posibles causas: tu cuenta de Northstar no tiene créditos restantes, o tu clave de API configurada (BYOK) alcanzó su límite de cuota. Agrega créditos de Northstar o revisa la configuración de tu clave de API para reanudar el autocompletado.",
  "kilocode:autocomplete.creditsExhausted.addCredits": "Añadir créditos",
  "kilocode:autocomplete.authError.message":
    "El autocompletado de Northstar se ha pausado por un problema de autenticación. Posibles causas: no has iniciado sesión en Northstar, o tu clave de API (BYOK) no es válida o falta. Vuelve a iniciar sesión o revisa la configuración de la clave de API de tu proveedor.",
}
