export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.basic": "Saisie automatique Northstar",
  "kilocode:autocomplete.statusBar.tooltip.disabled": "Saisie automatique Northstar (désactivée)",
  ...
  "kilocode:autocomplete.toggleMessage": "Saisie automatique Northstar {{status}}",
  ...
  "kilocode:autocomplete.input.title": "Northstar : tâche rapide",
  "kilocode:autocomplete.input.placeholder": "p. ex., 'refactoriser cette fonction pour la rendre plus efficace'",
  "kilocode:autocomplete.commands.generateSuggestions": "Northstar : générer des modifications suggérées",
  ...
  "kilocode:autocomplete.codeAction.title": "Northstar : modifications suggérées",
  "kilocode:autocomplete.chatParticipant.fullName": "Agent Northstar",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "La saisie automatique Northstar est bloquée par un conflit avec GitHub Copilot. Pour résoudre ce problème, vous devez désactiver les suggestions en ligne de Copilot.",
  ...
  "kilocode:autocomplete.creditsExhausted.message":
    "La saisie semi-automatique de Northstar a été mise en pause. Causes possibles : votre compte Northstar n’a plus de crédits, ou votre clé API configurée (BYOK) a atteint sa limite de quota. Ajoutez des crédits Northstar ou vérifiez la configuration de votre clé API pour reprendre la saisie semi-automatique.",
  "kilocode:autocomplete.creditsExhausted.addCredits": "Ajouter des crédits",
  "kilocode:autocomplete.authError.message":
    "La saisie semi-automatique de Northstar a été mise en pause en raison d’un problème d’authentification. Causes possibles : vous n’êtes pas connecté à Northstar, ou votre clé API (BYOK) est invalide ou manquante. Reconnectez-vous ou vérifiez les paramètres de clé API de votre fournisseur.",
}
