...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.basic": "Northstar Autocomplete",
  "kilocode:autocomplete.statusBar.tooltip.disabled": "Northstar Autocomplete (disabled)",
  ...
  "kilocode:autocomplete.toggleMessage": "Northstar Autocomplete {{status}}",
  ...
  "kilocode:autocomplete.input.title": "Northstar: Quick Task",
  "kilocode:autocomplete.input.placeholder": "e.g., 'refactor this function to be more efficient'",
  "kilocode:autocomplete.commands.generateSuggestions": "Northstar: Generate Suggested Edits",
  ...
  "kilocode:autocomplete.codeAction.title": "Northstar: Suggested Edits",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "The Northstar Autocomplete is being blocked by a conflict with GitHub Copilot. To fix this, you must disable Copilot's inline suggestions.",
  ...
  "kilocode:autocomplete.creditsExhausted.message":
    "Northstar Autocomplete has been paused. Possible causes: your Northstar account has no remaining credits, or your configured API key (BYOK) has reached its quota limit. Add Northstar credits or check your API key configuration to resume autocomplete.",
  "kilocode:autocomplete.creditsExhausted.addCredits": "Add Credits",
  "kilocode:autocomplete.authError.message":
    "Northstar Autocomplete has been paused due to an authentication issue. Possible causes: you are not signed in to Northstar, or your API key (BYOK) is invalid or missing. Please sign in again or check your provider API key settings.",
}
