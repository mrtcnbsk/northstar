export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.basic": "Northstar autofullføring",
  "kilocode:autocomplete.statusBar.tooltip.disabled": "Northstar autofullføring (deaktivert)",
  ...
  "kilocode:autocomplete.toggleMessage": "Northstar autofullføring {{status}}",
  ...
  "kilocode:autocomplete.input.title": "Northstar: Hurtig oppgave",
  "kilocode:autocomplete.input.placeholder": "f.eks. 'refaktorer denne funksjonen så den blir mer effektiv'",
  "kilocode:autocomplete.commands.generateSuggestions": "Northstar: Generer foreslåtte redigeringer",
  ...
  "kilocode:autocomplete.codeAction.title": "Northstar: Foreslåtte redigeringer",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "Northstar autofullføring blokkeres av en konflikt med GitHub Copilot. For å fikse dette må du deaktivere Copilots inline-forslag.",
  ...
  "kilocode:autocomplete.creditsExhausted.message":
    "Northstar autofullføring er satt på pause. Mulige årsaker: Northstar-kontoen din har ingen gjenværende kreditter, eller den konfigurerte API-nøkkelen (BYOK) har nådd kvotegrensen. Legg til Northstar-kreditter eller kontroller API-nøkkelkonfigurasjonen for å gjenoppta autofullføring.",
  "kilocode:autocomplete.creditsExhausted.addCredits": "Legg til kreditter",
  "kilocode:autocomplete.authError.message":
    "Northstar autofullføring er satt på pause på grunn av et autentiseringsproblem. Mulige årsaker: du er ikke logget på Northstar, eller API-nøkkelen din (BYOK) er ugyldig eller mangler. Logg inn igjen eller kontroller innstillingene for leverandørens API-nøkkel.",
}
