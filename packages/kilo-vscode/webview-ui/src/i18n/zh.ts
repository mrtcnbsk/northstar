...
export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "请在此设备上安装 Anaconda Desktop，然后返回此处。Northstar 不会为你运行安装程序。",
  ...
  "provider.anaconda.state.signedOut": "请打开 Anaconda Desktop 并登录，然后再连接 Northstar。",
  "provider.anaconda.state.unauthorized":
    "Northstar 无法访问 Anaconda Desktop。请打开 Desktop，重新登录，并在需要时重新启动它。",
  ...
  "provider.anaconda.state.ready": "Northstar 找到了一个健康的本地文本生成服务器，可以导入其当前的连接设置。",
  ...
  "provider.anaconda.toast.refreshed.description": "当前本地服务器和模型在 Northstar 中已是最新。",
...
export const dict = {
  ...
  "agentRequirements.error.discoveryFailed": "Northstar 无法检查可用技能。",
  "agentRequirements.error.mcpStatusFailed": "Northstar 无法检查 MCP 服务器状态。",
  "agentRequirements.error.scopeMismatch": "此代理要求检查已不再有效。",
  "agentRequirements.error.requestFailed": "Northstar 无法检查代理要求。",
  ...
  "dialog.model.unpaid.freeModels.title": "Northstar 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 Northstar 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 Northstar 中使用 {{provider}} 模型。",
  ...
  "prompt.action.sandbox.enabled": "沙盒已启用。代理 shell 命令被限制在项目和 Northstar 目录内。",
  "prompt.action.sandbox.disabled": "沙盒已禁用。点击以将代理 shell 命令的写入限制在项目和 Northstar 目录内。",
  ...
  "prompt.action.sandbox.description.enabled": "写入仅限项目和 Northstar 目录。",
  "prompt.action.sandbox.description.disabled": "点击以限制文件系统写入和网络访问。",
  "prompt.action.sandbox.description.disabledNetworkAllowed":
    "点击以限制文件系统写入。根据你的沙盒设置，网络访问仍然允许。",

  "speechToText.tooltip.start": "使用 Northstar Gateway 开始语音输入",
  ...
  "speechToText.error.loginRequired": "登录 Northstar 以使用语音输入。",
  ...
  "dialog.server.description": "切换此应用连接的 Northstar 服务器。",
  ...
  "toast.update.description": "Northstar 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 Northstar 团队",
  ...
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: Northstar 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "Northstar 提供免费模型，你可以立即开始使用。",
  ...
  "settings.general.row.language.description": "更改 Northstar 的显示语言",
  "settings.general.row.appearance.title": "外观",
  "settings.general.row.appearance.description": "自定义 Northstar 在你的设备上的外观",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 Northstar 的主题。",
  ...
  "settings.updates.row.startup.description": "在 Northstar 启动时自动检查更新",
  ...
  "settings.indexing.kiloModel.title": "Northstar 模型预设",
  "settings.indexing.kiloModel.description": "选择受支持的 Northstar 托管嵌入模型。",
  "settings.indexing.kiloSignIn.title": "需要登录 Northstar",
  "settings.indexing.kiloSignIn.description": "登录 Northstar 以使用托管嵌入。",
  ...
  "settings.providers.betaNotice":
    "目前只能在设置界面中配置 Northstar Gateway 提供商。在 Beta 测试期间即将支持配置其他提供商。在此期间，您可以使用 CLI 或配置文件来配置提供商。我们致力于保持 Northstar 开放，无锁定。",
  ...
  "settings.models.hidePromptTraining.description": "隐藏提供商可能会使用您的提示词进行训练的 Northstar Gateway 模型。",
  ...
  "settings.config.title": "打开 {{scope}} Northstar 配置文件",
  "settings.config.placeholder": "配置文件按顺序合并；标记为已加载的文件目前会影响设置。",
  "settings.config.noWorkspace": "打开工作区文件夹以编辑本地 Northstar 配置文件。",
  "settings.config.openFailed": "无法打开 {{scope}} Northstar 配置文件：{{message}}",
  ...
  "workStyle.onboarding.welcome": "欢迎使用 Northstar",
  ...
  "workStyle.choice.human-in-the-loop.description": "Northstar 会在工作过程中暂停并向你展示其计划。",
  ...
  "settings.aboutKiloCode.title": "关于 Northstar",

  "session.messages.empty": "在下方输入消息以开始对话。",
  "session.messages.welcome": "Northstar 是一个 AI 编程助手。让它帮你构建功能、修复 bug 或解释代码库。",
  ...
  "settings.aboutKiloCode.extensionName": "Northstar 扩展",
  ...
  "settings.aboutKiloCode.importSettings.invalidConfig": "文件不包含有效的 Northstar 设置。",
  "settings.aboutKiloCode.importSettings.tooLarge": "文件过大。设置文件必须小于 1 MB。",
  "settings.aboutKiloCode.importSettings.newerVersion": "此文件由较新版本的 Northstar 导出。部分设置可能会被忽略。",
  ...
  "settings.language.description": '"自动"将使用 VS Code 的显示语言。选择 Northstar 界面的语言。',
  ...
  "settings.models.speechToTextModel.description": "选择用于语音输入的 Northstar Gateway 转录模型。",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "将 Claude Code 配置目录中的 CLAUDE.md 指令和技能加载到会话中。如果您希望 Northstar 使用您的 Claude Code 指令和技能，请启用此选项。需要重启。",
  ...
  "settings.sandboxing.enabled.description":
    "在操作系统级沙盒中运行代理 shell 命令，将写入限制在项目和 Northstar 状态目录内",
  ...
  "settings.display.fontSize.description": "独立于 VS Code 调整 Northstar webview UI 的字体大小。",
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "从旧版 Northstar 安装迁移设置，包括提供商 API 密钥和默认模型。",
  ...
  "migration.whatsNew.features.foundation.detail":
    "所有 Northstar 产品共享一个小巧高效的核心。无论你选择哪种方式工作，都能获得熟悉的体验。",
  ...
  "diffViewer.source.session.tooltip": "Northstar 在当前会话中更改的文件，基于每轮快照。开始新会话时重置。",
