...
export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Installieren Sie Anaconda Desktop auf diesem Computer und kehren Sie dann hierher zurück. Northstar führt das Installationsprogramm nicht für Sie aus.",
  ...
  "provider.anaconda.state.ready":
    "Northstar hat einen funktionsfähigen lokalen Textgenerierungsserver gefunden und kann dessen aktuelle Verbindungseinstellungen importieren.",
  ...
  "provider.anaconda.toast.refreshed.description":
    "Der aktive lokale Server und die Modelle sind in Northstar auf dem neuesten Stand.",
...
export const dict = {
  ...
  "agentRequirements.error.discoveryFailed": "Northstar konnte die verfügbaren Skills nicht prüfen.",
  "agentRequirements.error.mcpStatusFailed": "Northstar konnte den MCP-Serverstatus nicht prüfen.",
  "agentRequirements.error.scopeMismatch": "Diese Prüfung der Agentenanforderungen ist nicht mehr aktiv.",
  "agentRequirements.error.requestFailed": "Northstar konnte die Agentenanforderungen nicht prüfen.",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von Northstar",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Northstar zu nutzen.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in Northstar zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Northstar zu nutzen.",
  ...
  "prompt.action.sandbox.enabled":
    "Sandbox ist aktiviert. Shell-Befehle des Agenten sind auf die Projekt- und Northstar-Verzeichnisse beschränkt.",
  "prompt.action.sandbox.disabled":
    "Sandbox ist deaktiviert. Klicken, um Schreibvorgänge der Shell-Befehle des Agenten auf die Projekt- und Northstar-Verzeichnisse zu beschränken.",
  ...
  "prompt.action.sandbox.description.enabled":
    "Schreibvorgänge sind auf die Projekt- und Northstar-Verzeichnisse beschränkt.",
  ...
  "speechToText.tooltip.start": "Spracheingabe mit Northstar Gateway starten",
  ...
  "speechToText.error.loginRequired": "Melden Sie sich bei Northstar an, um die Spracheingabe zu verwenden.",
  ...
  "dialog.server.description": "Wechseln Sie den Northstar-Server, mit dem sich diese App verbindet.",
  ...
  "toast.update.description": "Eine neue Version von Northstar ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Northstar-Team",
  ...
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Northstar unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "Northstar enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Northstar ändern",
  "settings.general.row.appearance.title": "Erscheinungsbild",
  "settings.general.row.appearance.description": "Anpassen, wie Northstar auf Ihrem Gerät aussieht",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Northstar anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von Northstar automatisch nach Updates suchen",
  ...
  "settings.indexing.kiloModel.title": "Northstar-Modellvoreinstellung",
  "settings.indexing.kiloModel.description": "Wählen Sie ein unterstütztes von Northstar gehostetes Embedding-Modell.",
  "settings.indexing.kiloSignIn.title": "Northstar-Anmeldung erforderlich",
  "settings.indexing.kiloSignIn.description": "Melden Sie sich bei Northstar an, um gehostete Embeddings zu verwenden.",
  ...
  "settings.models.hidePromptTraining.description":
    "Blendet Northstar-Gateway-Modelle aus, deren Anbieter Ihre Prompts möglicherweise zum Training verwenden.",
  ...
  "settings.config.title": "{{scope}} Northstar-Konfigurationsdatei öffnen",
  ...
  "settings.config.noWorkspace":
    "Öffnen Sie einen Arbeitsbereichsordner, um die lokale Northstar-Konfigurationsdatei zu bearbeiten.",
  "settings.config.openFailed": "Fehler beim Öffnen der {{scope}} Northstar-Konfigurationsdatei: {{message}}",
  ...
  "workStyle.onboarding.welcome": "Willkommen bei Northstar",
  ...
  "workStyle.choice.human-in-the-loop.description": "Northstar pausiert und zeigt dir während der Arbeit seinen Plan.",
  ...
  "deviceAuth.title": "Bei Northstar anmelden",
  ...
  "profile.action.login": "Mit Northstar anmelden",
  ...
  "profile.pass.subscribe": "Hol dir Northstar Pass, um Guthaben hinzuzufügen und Boni zu verdienen",
  ...
  "settings.aboutKiloCode.title": "Über Northstar",

  "session.messages.empty": "Starten Sie eine Unterhaltung, indem Sie unten eine Nachricht eingeben.",
  "session.messages.welcome":
    "Northstar ist ein KI-Programmierassistent. Bitten Sie ihn, Funktionen zu erstellen, Fehler zu beheben oder Ihre Codebasis zu erklären.",
  ...
  "settings.aboutKiloCode.extensionName": "Northstar Erweiterung",
  ...
  "settings.aboutKiloCode.importSettings.invalidConfig": "Die Datei enthält keine gültigen Northstar-Einstellungen.",
  ...
  "settings.aboutKiloCode.importSettings.newerVersion":
    "Diese Datei wurde mit einer neueren Version von Northstar exportiert. Einige Einstellungen werden möglicherweise ignoriert.",
  ...
  "settings.language.description":
    'Wählen Sie die Sprache für die Northstar Oberfläche. „Auto" verwendet die VS Code Anzeigesprache.',
  ...
  "settings.experimental.speechToText.description":
    "Aktivieren Sie die Spracheingabe in Prompt-Feldern mit Ihrem Northstar-Konto über Northstar Gateway.",
  "settings.models.speechToText.disabledDescription":
    "Aktivieren Sie den Northstar-Anbieter und melden Sie sich an, um Speech to Text zu verwenden. Speech to Text wird derzeit nur mit Northstar Gateway unterstützt.",
  "settings.models.speechToTextModel.title": "Sprache-zu-Text-Modell",
  "settings.models.speechToTextModel.description":
    "Wählen Sie das Northstar Gateway-Transkriptionsmodell für die Spracheingabe.",
  ...
  "settings.experimental.remote.description":
    "Aktivieren Sie die Remote-Steuerung von Sitzungen über Northstar Cloud. Dies betrifft auch CLIs auf diesem Computer.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Lädt CLAUDE.md-Anweisungen und Skills aus Ihrem Claude Code-Konfigurationsverzeichnis in Sitzungen. Aktivieren Sie dies, wenn Northstar Ihre Claude Code-Anweisungen und Skills verwenden soll. Neustart erforderlich.",
  ...
  "settings.sandboxing.enabled.description":
    "Shell-Befehle des Agenten in einer Sandbox auf Betriebssystemebene ausführen, die Schreibvorgänge auf die Projekt- und Northstar-Statusverzeichnisse beschränkt",
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "Migrieren Sie Einstellungen von einer früheren Installation von Northstar, einschließlich Anbieter-API-Schlüsseln und dem Standardmodell.",
  ...
  // Screen 1 — What's New
  "migration.whatsNew.title": "Neuigkeiten in Northstar",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Ein kleiner, effizienter Kern über alle Northstar-Produkte hinweg. Ein vertrautes Erlebnis, egal wie Sie arbeiten.",
  ...
  "diffViewer.source.session.tooltip":
    "Von Northstar während der aktuellen Sitzung geänderte Dateien, basierend auf Snapshots pro Runde. Wird beim Start einer neuen Sitzung zurückgesetzt.",
