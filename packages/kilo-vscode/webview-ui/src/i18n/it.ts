export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Installa Anaconda Desktop su questo computer, poi torna qui. Northstar non esegue il programma di installazione per te.",
  ...
  "provider.anaconda.state.unauthorized":
    "Northstar non è riuscito ad accedere ad Anaconda Desktop. Apri Desktop, accedi di nuovo e riavvialo se necessario.",
  ...
  "provider.anaconda.state.ready":
    "Northstar ha trovato un server locale di generazione del testo integro e può importare le sue attuali impostazioni di connessione.",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelli gratuiti forniti da Northstar",
  ...
  "dialog.server.description": "Cambia il server Northstar a cui si connette questa app.",
  ...
  "toast.update.description": "Una nuova versione di Northstar ({{version}}) è disponibile per l'installazione.",
  ...
  "error.page.report.prefix": "Segnala questo errore al team Northstar",
  ...
  "sidebar.gettingStarted.line1": "Northstar include modelli gratuiti, così puoi iniziare subito.",
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione di Northstar",
  "settings.general.row.appearance.title": "Aspetto",
  "settings.general.row.appearance.description": "Personalizza l'aspetto di Northstar sul tuo dispositivo",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti quando Northstar si avvia",
  ...
  "settings.providers.betaNotice":
    "Al momento solo il provider Northstar Gateway può essere configurato dall'interfaccia delle impostazioni. Il supporto per altri provider arriverà durante il periodo beta. Nel frattempo puoi configurare i provider con la CLI o il file di configurazione. Ci impegniamo a mantenere Northstar aperto, senza lock-in.",
  ...
  "settings.config.title": "Apri file config Northstar {{scope}}",
  "settings.config.placeholder":
    "I file config vengono uniti in ordine; i file marcati come caricati influenzano attualmente le impostazioni.",
  "settings.config.noWorkspace": "Apri una cartella workspace per modificare il file config Northstar locale.",
  "settings.config.openFailed": "Apertura file config Northstar {{scope}} non riuscita: {{message}}",
  ...
  "workStyle.onboarding.welcome": "Ti diamo il benvenuto in Northstar",
  ...
  "deviceAuth.title": "Accedi a Northstar",
  ...
  "profile.action.login": "Accedi con Northstar",
  ...
  "profile.pass.subscribe": "Ottieni Northstar Pass per aggiungere crediti e guadagnare bonus",
  ...
  "settings.aboutKiloCode.title": "Informazioni su Northstar",
  "session.messages.empty": "Avvia una conversazione scrivendo un messaggio qui sotto.",
  "session.messages.welcome":
    "Northstar è un assistente AI per il coding. Chiedigli di creare feature, correggere bug o spiegare il codebase.",
  ...
  "settings.aboutKiloCode.extensionName": "Estensione Northstar",
  ...
  "settings.aboutKiloCode.importSettings.invalidConfig": "Il file non contiene impostazioni Northstar valide.",
  ...
  "settings.experimental.remote.description":
    "Abilita controllo remoto delle sessioni tramite Northstar Cloud. Influenzerà anche le CLI su questa macchina.",
  ...
  "settings.sandboxing.enabled.description":
    "Esegui i comandi shell dell'agente all'interno di un sandbox a livello di sistema operativo che limita le scritture alle directory di stato del progetto e di Northstar",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Carica istruzioni CLAUDE.md e skill dalla directory di configurazione Claude Code nelle sessioni. Abilitalo se vuoi che Northstar usi istruzioni e skill di Claude Code. Richiede riavvio.",
  ...
  "settings.display.fontSize.description":
    "Regola la dimensione del font della webview Northstar indipendentemente da VS Code.",
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "Migra le impostazioni da una precedente installazione di Northstar, incluse API key dei provider e modello predefinito.",
  ...
  "migration.whatsNew.title": "Novità in Northstar",
  ...
  "diffViewer.source.session.tooltip":
    "File modificati da Northstar durante la sessione corrente, basati su snapshot per turno. Si resetta quando inizi una nuova sessione.",
  ...
  "settings.experimental.speechToText.description":
    "Abilita input vocale nei campi prompt usando il tuo account Northstar tramite Northstar Gateway.",
  ...
  "settings.models.hidePromptTraining.description":
    "Nascondi i modelli Northstar Gateway i cui provider potrebbero usare i tuoi prompt per l'addestramento.",
  ...
  "settings.indexing.kiloModel.title": "Preset modello Northstar",
  "settings.indexing.kiloModel.description": "Scegli un modello embedding ospitato da Kilo.",
  "settings.indexing.kiloSignIn.title": "Accesso Northstar richiesto",
  "settings.indexing.kiloSignIn.description": "Accedi a Northstar per usare gli embedding ospitati.",
  ...
  "agentRequirements.error.discoveryFailed": "Northstar non ha potuto controllare le skill disponibili.",
  "agentRequirements.error.mcpStatusFailed": "Northstar non ha potuto controllare lo stato del server MCP.",
  "agentRequirements.error.scopeMismatch": "Questo controllo dei requisiti dell’agente non è più attivo.",
  "agentRequirements.error.requestFailed": "Northstar non ha potuto controllare i requisiti dell’agente.",
  ...
  "speechToText.tooltip.start": "Avvia input vocale con Northstar Gateway",
  ...
  "speechToText.error.loginRequired": "Accedi a Northstar per usare l'input vocale.",
