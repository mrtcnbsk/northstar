...
export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "請在此機器上安裝 Anaconda Desktop，然後返回此處。Northstar 不會為您執行安裝程式。",
  ...
  "provider.anaconda.state.signedOut": "請開啟 Anaconda Desktop 並登入，然後再連接 Northstar。",
  "provider.anaconda.state.unauthorized":
    "Northstar 無法存取 Anaconda Desktop。請開啟 Desktop，重新登入，並在需要時重新啟動它。",
  ...
  "provider.anaconda.state.ready": "Northstar 找到了一個正常運作的本機文字生成伺服器，並可匯入其目前的連接設定。",
  ...
  "provider.anaconda.toast.refreshed.description": "使用中的本機伺服器與模型在 Northstar 中已是最新狀態。",
...
export const dict = {
  ...
  "agentRequirements.error.discoveryFailed": "Northstar 無法檢查可用技能。",
  "agentRequirements.error.mcpStatusFailed": "Northstar 無法檢查 MCP 伺服器狀態。",
  "agentRequirements.error.scopeMismatch": "此代理需求檢查已不再有效。",
  "agentRequirements.error.requestFailed": "Northstar 無法檢查代理需求。",
  ...
  "dialog.model.unpaid.freeModels.title": "Northstar 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 Northstar 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 Northstar 中使用 {{provider}} 模型。",
  ...
  "prompt.action.sandbox.enabled": "沙盒已啟用。代理 shell 指令被限制在專案和 Northstar 目錄內。",
  "prompt.action.sandbox.disabled": "沙盒已停用。點擊以將代理 shell 指令的寫入限制在專案和 Northstar 目錄內。",
  ...
  "prompt.action.sandbox.description.enabled": "寫入僅限於專案和 Northstar 目錄。",
  ...
  "speechToText.tooltip.start": "使用 Northstar Gateway 開始語音輸入",
  ...
  "speechToText.error.loginRequired": "登入 Northstar 以使用語音輸入。",
  ...
  "dialog.server.description": "切換此應用程式連線的 Northstar 伺服器。",
  ...
  "toast.update.description": "Northstar 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 Northstar 團隊",
  ...
  "error.chain.mcpFailed": 'MCP 伺服器 "{{name}}" 啟動失敗。注意：Northstar 暫不支援 MCP 認證。',
  ...
  "sidebar.gettingStarted.line1": "Northstar 提供免費模型，你可以立即開始使用。",
  ...
  "settings.general.row.language.description": "變更 Northstar 的顯示語言",
  "settings.general.row.appearance.title": "外觀",
  "settings.general.row.appearance.description": "自訂 Northstar 在你的裝置上的外觀",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 Northstar 的主題。",
  ...
  "settings.updates.row.startup.description": "在 Northstar 啟動時自動檢查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 Northstar。",
  ...
  "settings.providers.betaNotice":
    "目前在設定介面中僅能配置 Northstar Gateway 供應商。在測試期間，即將推出配置其他供應商的支援。在此期間，您可以使用 CLI 或設定檔來配置供應商。我們致力於保持 Northstar 開放，絕不綁定。",
  ...
  "settings.models.hidePromptTraining.description": "隱藏供應商可能會使用您的提示詞進行訓練的 Northstar Gateway 模型。",
  ...
  "settings.config.title": "開啟 {{scope}} Northstar 設定檔",
  "settings.config.placeholder": "設定檔會按順序合併；標記為已載入的檔案目前會影響設定。",
  "settings.config.noWorkspace": "開啟工作區資料夾以編輯本地 Northstar 設定檔。",
  "settings.config.openFailed": "無法開啟 {{scope}} Northstar 設定檔：{{message}}",
  ...
  "workStyle.onboarding.welcome": "歡迎使用 Northstar",
  ...
  "workStyle.choice.human-in-the-loop.description": "Northstar 會在工作過程中暫停並向你顯示其計畫。",
  ...
  "settings.aboutKiloCode.title": "關於 Northstar",

  "session.messages.empty": "在下方輸入訊息以開始對話。",
  "session.messages.welcome": "Northstar 是一個 AI 程式設計助手。讓它幫你建構功能、修復 bug 或解釋程式碼庫。",
  ...
  "settings.aboutKiloCode.extensionName": "Northstar 擴充功能",
  ...
  "settings.aboutKiloCode.importSettings.invalidConfig": "檔案不包含有效的 Northstar 設定。",
  "settings.aboutKiloCode.importSettings.tooLarge": "檔案過大。設定檔必須小於 1 MB。",
  "settings.aboutKiloCode.importSettings.newerVersion": "此檔案由較新版本的 Northstar 匯出。部分設定可能會被忽略。",
  ...
  "settings.language.description": "選擇 Northstar 介面的語言。「自動」使用 VS Code 的顯示語言。",
  ...
  "settings.models.speechToTextModel.description": "選擇用於語音輸入的 Northstar Gateway 轉錄模型。",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "從您的 Claude Code 設定目錄將 CLAUDE.md 指示與技能載入至工作階段中。如果您希望 Northstar 使用您的 Claude Code 指示與技能，請啟用此選項。需要重新啟動。",
  ...
  "settings.sandboxing.enabled.description":
    "在作業系統層級沙盒中執行代理 shell 指令，將寫入限制在專案和 Northstar 狀態目錄內",
  ...
  "settings.display.fontSize.description": "獨立於 VS Code 調整 Northstar webview UI 的字體大小。",
  ...
  "settings.indexing.kiloModel.title": "Northstar 模型預設",
  "settings.indexing.kiloModel.description": "選擇支援的 Northstar 託管嵌入模型。",
  "settings.indexing.kiloSignIn.title": "需要登入 Northstar",
  "settings.indexing.kiloSignIn.description": "登入 Northstar 以使用託管嵌入。",
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "從舊版 Northstar 安裝遷移設定，包括供應商 API 金鑰和預設模型。",
  ...
  // Screen 1 — What's New
  "migration.whatsNew.title": "Northstar 新功能",
  ...
  "migration.whatsNew.features.foundation.detail":
    "所有 Northstar 產品共享一個小巧高效的核心。無論你選擇哪種方式工作，都能獲得熟悉的體驗。",
  ...
  "diffViewer.source.session.tooltip": "Northstar 在目前工作階段中變更的檔案，依據每輪快照。開始新工作階段時重置。",
