...
export const dict = {
  ...
  "toast.update.description":
    "Une nouvelle version d'Northstar ({{version}}) est maintenant disponible pour installation.",
  ...
  "sidebar.gettingStarted.line1":
    "Northstar inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
