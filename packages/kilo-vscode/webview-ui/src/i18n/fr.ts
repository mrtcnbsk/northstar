export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Installez Anaconda Desktop sur cette machine, puis revenez ici. Northstar n’exécute pas l’installateur à votre place.",
  ...
  "provider.anaconda.state.unauthorized":
    "Northstar n’a pas pu accéder à Anaconda Desktop. Ouvrez Desktop, reconnectez-vous et redémarrez-le si nécessaire.",
  ...
  "provider.anaconda.state.ready":
    "Northstar a trouvé un serveur local sain de génération de texte et peut importer ses paramètres de connexion actuels.",
...
export const dict = {
  ...
  "agentRequirements.error.discoveryFailed": "Northstar n’a pas pu vérifier les compétences disponibles.",
  "agentRequirements.error.mcpStatusFailed": "Northstar n’a pas pu vérifier l’état du serveur MCP.",
  "agentRequirements.error.scopeMismatch": "Cette vérification des prérequis de l’agent n’est plus active.",
  "agentRequirements.error.requestFailed": "Northstar n’a pas pu vérifier les prérequis de l’agent.",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Northstar",
  ...
  "speechToText.tooltip.start": "Démarrer la saisie vocale avec Northstar Gateway",
  ...
  "speechToText.error.loginRequired": "Connectez-vous à Northstar pour utiliser la saisie vocale.",
  ...
  "dialog.server.description": "Changez le serveur Northstar auquel cette application se connecte.",
  ...
  "toast.update.description": "Une nouvelle version d'Northstar ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Northstar",
  ...
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Northstar ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1": "Northstar inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Northstar",
  "settings.general.row.appearance.title": "Apparence",
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Northstar sur votre appareil",
  ...
  "settings.indexing.kiloModel.title": "Préréglage de modèle Northstar",
  "settings.indexing.kiloModel.description": "Choisissez un modèle d'embedding hébergé par Northstar pris en charge.",
  "settings.indexing.kiloSignIn.title": "Connexion à Northstar requise",
  "settings.indexing.kiloSignIn.description": "Connectez-vous à Northstar pour utiliser les embeddings hébergés.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Northstar",
  ...
  "settings.providers.betaNotice":
    "Actuellement, seul le fournisseur Northstar Gateway peut être configuré dans l'interface des paramètres. La prise en charge de la configuration d'autres fournisseurs sera bientôt disponible pendant la période bêta. En attendant, vous pouvez configurer les fournisseurs à l'aide de la CLI ou du fichier de configuration. Nous nous engageons à maintenir Northstar ouvert, sans enfermement propriétaire.",
  ...
  "settings.models.hidePromptTraining.description":
    "Masquez les modèles Northstar Gateway dont les fournisseurs peuvent utiliser vos prompts à des fins d'entraînement.",
  ...
  "settings.config.title": "Ouvrir le fichier de configuration Northstar {{scope}}",
  ...
  "settings.config.noWorkspace":
    "Ouvrez un dossier d'espace de travail pour modifier le fichier de configuration Northstar local.",
  "settings.config.openFailed": "Échec de l'ouverture du fichier de configuration Northstar {{scope}} : {{message}}",
  ...
  "workStyle.onboarding.welcome": "Bienvenue dans Northstar",
  ...
  "workStyle.choice.human-in-the-loop.description":
    "Northstar s'interrompt et vous présente son plan au fil de son travail.",
  ...
  "deviceAuth.title": "Se connecter à Northstar",
  ...
  "profile.action.login": "Se connecter avec Northstar",
  ...
  "profile.pass.subscribe": "Obtenez Northstar Pass pour ajouter des crédits et gagner des bonus",
  ...
  "settings.aboutKiloCode.title": "À propos de Northstar",

  "session.messages.empty": "Commencez une conversation en tapant un message ci-dessous.",
  "session.messages.welcome":
    "Northstar est un assistant de programmation IA. Demandez-lui de créer des fonctionnalités, corriger des bugs ou expliquer votre code.",
  ...
  "settings.aboutKiloCode.extensionName": "Extension Northstar",
  ...
  "settings.aboutKiloCode.importSettings.invalidConfig": "Le fichier ne contient pas de paramètres Northstar valides.",
  ...
  "settings.language.description":
    "Choisissez la langue de l'interface de Northstar Code. \"Auto\" utilise la langue d'affichage de VS Code.",
  ...
  "settings.experimental.speechToText.description":
    "Activez la saisie vocale dans les champs de prompt en utilisant votre compte Northstar via Northstar Gateway.",
  "settings.models.speechToText.disabledDescription":
    "Activez et connectez-vous au fournisseur Northstar pour utiliser Speech to Text. Speech to Text n'est actuellement pris en charge qu'avec Northstar Gateway.",
  "settings.models.speechToTextModel.title": "Modèle de transcription vocale",
  "settings.models.speechToTextModel.description":
    "Choisissez le modèle de transcription Northstar Gateway pour la saisie vocale.",
  ...
  "settings.experimental.remote.description":
    "Activez le contrôle Remote des sessions via Northstar Cloud. Cela affectera également les CLI sur cette machine.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Charge les instructions et les compétences de CLAUDE.md depuis votre répertoire de configuration Claude Code dans les sessions. Activez cette option si vous souhaitez que Northstar utilise vos instructions et compétences Claude Code. Nécessite un redémarrage.",
  ...
  "settings.sandboxing.enabled.description":
    "Exécuter les commandes shell de l'agent dans un sandbox au niveau du système d'exploitation qui restreint les écritures aux répertoires d'état du projet et de Northstar",
  ...
  "settings.display.fontSize.description":
    "Ajustez la taille de la police de la webview UI de Northstar indépendamment de VS Code.",
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "Migrer les paramètres d'une précédente installation de Northstar, y compris les clés d'API des fournisseurs et le modèle par défaut.",
  ...
  // Screen 1 — What's New
  "migration.whatsNew.title": "Nouveautés de Northstar",
  ...
  "diffViewer.source.session.tooltip":
    "Fichiers modifiés par Northstar pendant la session actuelle, basé sur des snapshots par tour. Réinitialisé lors du démarrage d'une nouvelle session.",
