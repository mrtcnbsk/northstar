...
describe("kilocode tool registry indexing", () => {
  ...
  const orgIDs = ["org_start", "org_advance", "org_decision", "org_status", "org_stop", "org_note", "org_route"]
  ...
  test("conditionally includes Kilo registry extras", () => {
    ...
    const tools = {
      ...
      xcodeArchive: def("xcode_archive"),
      ipaExport: def("ipa_export"),
