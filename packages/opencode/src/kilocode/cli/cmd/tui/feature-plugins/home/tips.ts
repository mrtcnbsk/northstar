...
export const KILO_TIPS: Tip[] = [
  ...
  "Create a plugin to prevent Northstar from reading sensitive files",
  ...
  "Run {highlight}northstar agent create{/highlight} for guided agent creation",
  "Run {highlight}northstar github install{/highlight} to set up the GitHub workflow",
  ...
  "Run {highlight}northstar debug config{/highlight} to troubleshoot configuration",
  ...
  "Use {highlight}/connect{/highlight} with Northstar Gateway for curated, tested models",
