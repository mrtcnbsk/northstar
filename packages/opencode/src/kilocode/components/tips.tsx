...
const TIPS = [
  ...
  "Northstar can {highlight}configure itself{/highlight} if you ask it",
  "Ask Northstar to {highlight}add Supabase MCP globally{/highlight}",
  "Ask Northstar to {highlight}create a review agent for this project{/highlight}",
  "Ask Northstar to {highlight}add a plugin for desktop alerts{/highlight}",
  "Ask Northstar to {highlight}set Claude Sonnet as my default model{/highlight}",
  "Ask Northstar to {highlight}make my review agent read-only{/highlight}",
  "Ask Northstar to {highlight}require approval before git push{/highlight}",
  "Ask Northstar to {highlight}turn off auto-formatting{/highlight}",
  "Ask Northstar to {highlight}block access to .env files{/highlight}",
  "Ask Northstar to {highlight}turn off the F2 shortcut{/highlight}",
  "Ask Northstar to {highlight}match my terminal theme{/highlight}",
  "Ask Northstar to {highlight}disable sharing for all sessions{/highlight}",
  "Ask Northstar to {highlight}add rules from docs/ai-rules.md{/highlight}",
  "Ask Northstar to {highlight}enable tui.scroll_acceleration{/highlight} for smooth macOS-style scrolling",
  "Ask Northstar to {highlight}save this workflow as a /command{/highlight}",
  "Northstar auto-handles OAuth for remote MCP servers requiring auth",
  "Northstar auto-formats files using prettier, gofmt, ruff, and more",
  "Northstar uses LSP servers for intelligent code analysis",
  "Use {highlight}northstar run{/highlight} for non-interactive scripting",
  "Use {highlight}northstar --continue{/highlight} to resume the last session",
  "Use {highlight}northstar run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}northstar serve{/highlight} for headless API access to Northstar",
  "Use {highlight}northstar run --attach{/highlight} to connect to a running server",
  "Run {highlight}northstar upgrade{/highlight} to update to the latest version",
  "Run {highlight}northstar auth list{/highlight} to see all configured providers",
