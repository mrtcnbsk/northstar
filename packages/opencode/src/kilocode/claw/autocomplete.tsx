...
export function ClawAutocomplete(props: {
  ...
  useBindings(() => ({
    ...
    bindings: [
      { key: "up", desc: "Previous command", group: "Northstar Claw", cmd: () => move(-1) },
      { key: "ctrl+p", desc: "Previous command", group: "Northstar Claw", cmd: () => move(-1) },
      { key: "down", desc: "Next command", group: "Northstar Claw", cmd: () => move(1) },
      { key: "ctrl+n", desc: "Next command", group: "Northstar Claw", cmd: () => move(1) },
      { key: "escape", desc: "Hide autocomplete", group: "Northstar Claw", cmd: hide },
      { key: "return", desc: "Select command", group: "Northstar Claw", cmd: select },
      { key: "tab", desc: "Select command", group: "Northstar Claw", cmd: select },
      {
        key: "right",
        fallthrough: true,
        cmd: () => {
