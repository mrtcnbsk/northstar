      ...
      .add(
        HttpApiEndpoint.post("dispose", InstancePaths.dispose, {
          ...
          OpenApi.annotations({
            ...
            description: "Clean up and dispose the current Northstar instance, releasing all resources.", // kilocode_change
          }),
        ),
        HttpApiEndpoint.get("path", InstancePaths.path, {
          ...
          OpenApi.annotations({
            identifier: "path.get",
            summary: "Get paths",
            description: "Retrieve the current working directory and related path information for the Northstar instance.", // kilocode_change
          }),
        ),
        ...
        HttpApiEndpoint.get("command", InstancePaths.command, {
          ...
          OpenApi.annotations({
            ...
            description: "Get a list of all available commands in the Northstar system.", // kilocode_change
          }),
        ),
        HttpApiEndpoint.get("agent", InstancePaths.agent, {
          ...
          OpenApi.annotations({
            ...
            summary: "List agents",
            description: "Get a list of all available AI agents in the Northstar system.", // kilocode_change
          }),
        ),
        HttpApiEndpoint.get("skill", InstancePaths.skill, {
          ...
          OpenApi.annotations({
            ...
            summary: "List skills",
            description: "Get a list of all available skills in the Northstar system.", // kilocode_change
          }),
        ),
