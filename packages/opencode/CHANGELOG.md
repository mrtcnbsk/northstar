...
- [`8733b98`](https://github.com/mrtcnbsk/northstar/commit/8733b980a113dcaf22de872da8aaae252cc68a7d) Thanks [@mrtcnbsk](https://github.com/mrtcnbsk)! - TUI Chat — org slash commands, org roster in the agent selector, @mention side-channel notes (org_note), inline gate card.

- [`8733b98`](https://github.com/mrtcnbsk/northstar/commit/8733b980a113dcaf22de872da8aaae252cc68a7d) Thanks [@mrtcnbsk](https://github.com/mrtcnbsk)! - TUI Cockpit — live run dashboard (pipeline, agent tree, budget gauge, activity log), hard stop, gate/halt/budget notifications, run-list home, and `--dry-run`/`--auto`/`--attach` modes.

- [`8733b98`](https://github.com/mrtcnbsk/northstar/commit/8733b980a113dcaf22de872da8aaae252cc68a7d) Thanks [@mrtcnbsk](https://github.com/mrtcnbsk)! - Generalize the on-device agent organization kernel beyond iOS: kernel prompt copy is de-iOS'd
...
- [`8733b98`](https://github.com/mrtcnbsk/northstar/commit/8733b980a113dcaf22de872da8aaae252cc68a7d) Thanks [@mrtcnbsk](https://github.com/mrtcnbsk)! - Inherit the current model and reasoning variant when Agent Manager starts sessions without explicit overrides.
